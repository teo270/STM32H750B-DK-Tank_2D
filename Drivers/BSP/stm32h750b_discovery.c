...
static GPIO_TypeDef* LED_PORT[LEDn] = {LED1_GPIO_PORT,
                                       LED2_GPIO_PORT,LED3_GPIO_PORT}; // dodano LED3

static const  uint32_t LED_PIN[LEDn] = {LED1_PIN,
                                        LED2_PIN,LED3_PIN}; // dodano LED3
...
int32_t  BSP_LED_Init(Led_TypeDef Led)
{
  ...
  else if (Led == LED3)          // <-- dodano za LED3
  {
      LED3_GPIO_CLK_ENABLE();     // <-- makro, ki mora obstajati v BSP
  }
  else
  {
