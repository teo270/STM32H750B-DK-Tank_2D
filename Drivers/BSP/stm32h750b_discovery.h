...
typedef enum
{
  ...
  LED_RED = LED2,
  LED3 = 2,			 // dodano LED3
  LED_BLUE = LED3,   // opcijsko ime za LED3
  LEDn					// skupno število LED
} Led_TypeDef;
...
#endif
/**
  * @brief STM32H750B Discovery BSP Driver version number V3.3.1
  */
...
#define STM32H750B_DK_BSP_VERSION_SUB2   (0x01) /*!< [15:8]  sub2 version */
...
#define LED3_GPIO_PORT                   GPIOD   // preveri pravi port na PCB
#define LED3_PIN                         GPIO_PIN_3  // preveri pravi pin na PCB
...
#define LED3_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOD_CLK_ENABLE()   // Dodal za LED3 in sicer D
