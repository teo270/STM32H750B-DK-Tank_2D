...
/*
To je dejanski strojniški driver za LCD na STM32H750B-DK.
Zagotavlja funkcije, ki komunicirajo neposredno s LTDC (LCD-TFT controller)
in DMA2D (2D DMA kopiranje/polnjenje).
*/
